...
for ($i = 0; $i < 1000; $i++) {
    ...
    $event['id_user'] = rand(0, 1000);
    $event['id_address_event'] = rand(0, 1000);
...
for ($i = 0; $i < 1000; $i++) {
    $comment['id_user_from_user_to_comment'] = rand(0, 1000);
    $comment['id_event_from_event_to_comment'] = rand(0, 1000);
