<nav id="top" class="navbar navbar-default">
    <div class="navbar-collapse">
        ...
        <div class="visible-xs">
            @if ($user = session()->get('user'))
                <div class="collapse" id="navbarToggleExternalContent">
                    <div class="col-xs-12"><a href="/events">Events</a></div>
                    <div class="col-xs-12"><a href="/friends">Friends</a></div>
                    <div class="col-xs-12"><a href="/messages">Messages</a></div>
                    <div class="col-xs-12"><a href="/edit">Edit</a></div>
                    <div class="col-xs-12"><a href="/settings">Settings</a></div>
                    <div class="col-xs-12"><a href="/logout">Log out</a></div>
                </div>
                <span class="glyphicon glyphicon-menu-hamburger" type="button"
        ...
        @if(session()->get('user')->profile_status === 'admin')
